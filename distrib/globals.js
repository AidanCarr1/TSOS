...
//
const APP_NAME = "AquaOS"; // last minute name change
const APP_VERSION = "12.12"; // date of last edit, i will definetly forget to update this number
