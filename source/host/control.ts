...
module TSOS {
    ...
    export class Control {
        ...
        public static updateCPUDisplay(): void {
            ...
            (<HTMLInputElement> document.getElementById("Acc")).innerText = Utils.toHex(_CPU.Acc, HEX_WORD_SIZE);
        ...
        public static addPCBDisplay(pcb: ProcessControlBlock): void {
            ...
            rowHTML +=    "<td id='base"+pcb.pid+"'     class='pcbBox' >"+ Utils.toHex(pcb.getBase(), BASE_LIMIT_WORD_SIZE) +"</td>";
            rowHTML +=    "<td id='limit"+pcb.pid+"'    class='pcbBox' >"+ Utils.toHex(pcb.getLimit(), BASE_LIMIT_WORD_SIZE)+"</td>";
        ...
        public static updatePCBDisplay(pcb: ProcessControlBlock): void {
            ...
            document.getElementById("base"+pid).innerText     = Utils.toHex(pcb.getBase(), BASE_LIMIT_WORD_SIZE);
